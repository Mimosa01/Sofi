...
export default function CategoryCardLong({ text, href }: Props) {
  return (
    <Link
      href={href}
      className={`
        relative flex flex-col gap-3.5 p-4.5 md:p-5 font-semibold text-base md:text-2xl rounded-md 
        bg-neutral-100 overflow-hidden col-span-2 md:col-span-3 leading-4.5 md:leading-6.5
        group
        h-28 md:h-39
      `}
    >
