...
export default function MiniBodyCardYellow () {
  return (
    <div className="flex items-center justify-between p-[15px] bg-[#FDF6E2] bg-[url(/images/gridYellow.png)] rounded-lg">
      <div>
        <Heading level={4} className="font-semibold text-base">
