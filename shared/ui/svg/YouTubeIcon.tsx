...
function YouTubeIconComponent () {
  return (
    <svg
      ...
      viewBox="0 0 30 30"
      fill="none"
      className="fill-white group-hover:fill-[url(#grad)] transition-colors duration-300"
    >
      <defs>
        <linearGradient id="grad" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%" stopColor="rgb(226, 83, 119)" />
          <stop offset="50%" stopColor="rgb(238, 185, 2)" />
          <stop offset="100%" stopColor="rgb(98, 180, 255)" />
        </linearGradient>
        <clipPath id="clip0_5618_1527">
          <rect width="30" height="30" fill="white" />
        </clipPath>
      </defs>

      <g clipPath="url(#clip0_5618_1527)">
        <path
